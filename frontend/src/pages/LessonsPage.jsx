...
/>
  ...
  {lang.listenBtn}<br /><span style={{ fontSize: "0.75rem" }}>(L)</span>
              ...
              <button onClick={step === "done" ? () => navigate("/mcq", { state: { name, language, instructionLang } }) : nextLesson} aria-label="N — अगला lesson" style={{ padding: "1rem 0.5rem", fontSize: "0.9rem", borderRadius: "12px", background: ACCENT, color: "#1a1410", border: "none", cursor: "pointer", fontWeight: "bold" }}>
                {step === "done" ? "MCQ" : "अगला →"}<br /><span style={{ fontSize: "0.75rem" }}>(N)</span>
              </button>
            </div>
          </div>
